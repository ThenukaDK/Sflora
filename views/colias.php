...
$result = mysql_query("select * from sf_flowers_colias");


echo '<h1 class="page-header" style="color:#944D94;">Colias</h1>';
...
while ($data = mysql_fetch_array($result)) {
  ...
  <div class="placeholders" style="margin-top:40px;">
        ...
        <a href="descriptive.php?main=Colias&sub='.$image_subCategory.'&color='.$image_color.'&extra='.$image_extra.'" >
              <img src="../img/Flowers/Colias/'.$image_name.'"  class="img-responsive" alt="Colia Flower Image">
        </a>      
