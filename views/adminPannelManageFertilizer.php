...
<html lang="en" data-ng-app="sfloraPurchaseHistory">
  <head>
    ...
    <title>admin Panel-Anthurium-detail</title>
  ...
  <body data-ng-controller = "divChangeController">
    ...
    <div class="container cusMargin1">
	  ...
	  <div class="jumbotron cusMargin1">
        <h1>Anthurium</h1>
        <p class="lead">Add new anthurium or edit existing Flowers</p>
		<a href=""><button type="button" class="btn btn-default" data-ng-click="clickbtn='adminPanelAddNewFlower.php'" ><span class="fa fa-plus"></span> Add new anthurium</button></a>
	...
	<div class="table-responsive">
			<p class="lead">Anthurium Flowers in database</p>
			<hr>
            <table class="table table-striped">
              ...
              <tbody>
                <?php
					...
					$anthuriumdetails = "select * from sf_flowers_anthurium";
					$result = mysql_query($anthuriumdetails);
					while ($data = mysql_fetch_array($result)){
						echo'
						<form enctype="multipart/form-data" name="addAnthurium" method="post" action="addFlowersToDb.php?table=sf_flowers_anthurium"> 
							<tr>
