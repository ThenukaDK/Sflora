...
$result = mysql_query("select * from sf_flowers_water");


echo '<h1 class="page-header" style="color:#944D94;">Water Plants</h1>';
...
while ($data = mysql_fetch_array($result)) {
  ...
  <div class="placeholders" style="margin-top:40px;">
        ...
        <a href="descriptive.php?main=Water Plant&sub='.$image_subCategory.'&color='.$image_color.'&extra='.$image_extra.'" >
              <img src="../img/Flowers/Water Plant/'.$image_name.'"  class="img-responsive" alt="Water Plant Image">
        </a>     
