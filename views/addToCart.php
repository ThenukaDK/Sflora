<?php
	...
	//insert into temporary table sf_cart_temp
  ...
  <body data-ng-controller = "divChangeController">
    ...
    <div class="container cusMargin1">
	  ...
	  <div class="jumbotron cusMargin1">
		<a href="purchaseConfirm.php?value=addMore"><button class="btn btn-default btn-lg">Add More to Cart</button></a>
        <h1>Confirm Checkout</h1>
        <p class="lead">Are you sure you want to checkout this order?</p>
	...
	<div class="table-responsive">
            ...
            <table class="table table-striped">
              ...
              <tbody>
				<?php
					//retrieve temporary order raws
					$querry = "select * from sf_cart_temp where user_id = '$userId'";
