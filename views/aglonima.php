...
$result = mysql_query("select * from sf_flowers_aglonima");


echo '<h1 class="page-header" style="color:#944D94;">Aglonima</h1>';
...
while ($data = mysql_fetch_array($result)) {
  ...
  <div class="placeholders" style="margin-top:40px;">
        ...
        <a href="descriptive.php?main=Aglonima&sub='.$image_subCategory.'&color='.$image_color.'&extra='.$image_extra.'" >
            <img src="../img/Flowers/Aglonima/'.$image_name.'"  class="img-responsive" alt="Aglonima Flower Image">
        </a>      
