...
$result = mysql_query("select * from sf_flowers_orchid");


echo '<h1 class="page-header" style="color:#944D94;">Orchids</h1>';
...
while ($data = mysql_fetch_array($result)) {
  ...
  <div class="placeholders" style="margin-top:40px;">
        ...
        <a href="descriptive.php?main=Orchid&sub='.$image_subCategory.'&color='.$image_color.'&extra='.$image_extra.'" >
              <img src="../img/Flowers/Orchid/'.$image_name.'"  class="img-responsive" alt="Orchid Flower Image">
        </a>      
