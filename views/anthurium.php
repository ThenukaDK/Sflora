...
$result = mysql_query("select * from sf_flowers_anthurium");


echo '<h1 class="page-header" style="color:#944D94;">Anthurium</h1>';
...
while ($data = mysql_fetch_array($result)) {
  ...
  <div class="placeholders" style="margin-top:40px;" >
        ...
        <a href="descriptive.php?main=Anthurium&sub='.$image_subCategory.'&color='.$image_color.'&extra='.$image_extra.'" >
              <img src="../img/Flowers/Anthurium/'.$image_name.'"  class="img-responsive" alt="Anthurium Flower Image">
        </a>      
