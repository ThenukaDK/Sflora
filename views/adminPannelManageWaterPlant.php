...
<html lang="en" data-ng-app="sfloraPurchaseHistory">
  <head>
    ...
    <title>admin Panel-WaterPlant-detail</title>
  ...
  <body data-ng-controller = "divChangeController">
    ...
    <div class="container cusMargin1">
	  ...
	  <div class="jumbotron cusMargin1">
        <h1>Water Plants</h1>
        <p class="lead">Add new Water Plant or edit existing Flowers</p>
		<a href=""><button type="button" class="btn btn-default" data-ng-click="clickbtn='adminPanelAddNewFlower.php?table=<?php echo $table;?>'" ><span class="fa fa-plus"></span> Add new Water Plant</button></a>
	...
	<div class="table-responsive">
			<p class="lead">Water Plants Flowers in database</p>
			<hr>
