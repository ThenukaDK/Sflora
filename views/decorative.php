...
$result = mysql_query("select * from sf_flowers_decorative");


echo '<h1 class="page-header" style="color:#944D94;">Decorative Flowers</h1>';
...
while ($data = mysql_fetch_array($result)) {
  ...
  <div class="placeholders" style="margin-top:40px;">
        ...
        <a href="descriptive.php?main=Decorative&sub='.$image_subCategory.'&color='.$image_color.'&extra='.$image_extra.'" >
              <img src="../img/Flowers/Decorative/'.$image_name.'"  class="img-responsive" alt="Decorative Flower Image">
        </a>     
