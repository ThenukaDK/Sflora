  ...
  <body data-ng-controller = "divChangeController">
    ...
    <div class="container cusMargin1">
	  ...
	  <div class="jumbotron cusMargin1">
		...
		<a href=""><button type="button" class="btn btn-default" data-ng-click="clickbtn='adminPanelAddNewFlower.php?table=<?php echo $table;?>'"><span class="fa fa-plus"></span> Add new anthurium</button></a>
              ...
              <tbody>
                <?php
					...
					while ($data = mysql_fetch_array($result)){
						echo'
						<form enctype="multipart/form-data" name="addflower" method="post" action="addFlowersToDb.php?table=sf_flowers_'.$table.'"> 
							<tr>
