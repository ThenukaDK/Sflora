...
<html lang="en" data-ng-app="sfloraPurchaseHistory">
  <head>
    ...
    <title>admin Panel-Colias-detail</title>
  ...
  <body data-ng-controller = "divChangeController">
    ...
    <div class="container cusMargin1">
	  ...
	  <div class="jumbotron cusMargin1">
        <h1>Colias</h1>
        <p class="lead">Add new Colias or edit existing Flowers</p>
		<a href=""><button type="button" class="btn btn-default" data-ng-click="clickbtn='adminPanelAddNewFlower.php?table=<?php echo $table;?>'" ><span class="fa fa-plus"></span> Add new Colias</button></a>
	...
	<div class="table-responsive">
			<p class="lead">Colias Flowers in database</p>
			<hr>
