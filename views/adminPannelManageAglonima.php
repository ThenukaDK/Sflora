...
<html lang="en" data-ng-app="sfloraPurchaseHistory">
  <head>
    ...
    <title>admin Panel-Aglonima-detail</title>
  ...
  <body data-ng-controller = "divChangeController">
    ...
    <div class="container cusMargin1">
	  ...
	  <div class="jumbotron cusMargin1">
        <h1>Aglonima</h1>
        <p class="lead">Add new Aglonima or edit existing Flowers</p>
		<a href=""><button type="button" class="btn btn-default" data-ng-click="clickbtn='adminPanelAddNewFlower.php?table=<?php echo $table;?>'" ><span class="fa fa-plus"></span> Add new Aglonima</button></a>
	...
	<div class="table-responsive">
			<p class="lead">Aglonima Flowers in database</p>
			<hr>
                ...
                <?php
					...
					while ($data = mysql_fetch_array($result)){
						...
						<form enctype="multipart/form-data" name="addAnthurium" method="post" action="addFlowersToDb.php?table=sf_flowers_'.$table.'"> 
							<tr>
								<td><input type="text" class="" placeholder="" name="mainCatogory" value="'.$data['mainCatogory'].'"/></td>
								<td><input type="text" class="" placeholder="" name="subCatogory" value="'.$data['subCatogory'].'"/></td>
								<td><input type="text" class="" placeholder="" name="price" value="'.$data['price'].'"/></td>
								<td><input type="text" class="" placeholder="" name="stock" value="'.$data['stock'].'"/></td>
								<td><input type="text" class="" placeholder="" name="haveFlower" value="'.$data['haveFlower'].'"/></td>
								<td><input type="text" class="" placeholder="" name="color" value="'.$data['color'].'"/></td>
								<td><input type="text" class="" placeholder="" name="plantHeight" value="'.$data['plantHeight'].'"/></td>
								<td><input type="text" class="" placeholder="" name="climateCondition" value="'.$data['climateCondition'].'"/></td>
								<td><input type="text" class="" placeholder="" name="extraDetails" value="'.$data['extraDetails'].'"/></td>
								<td><input type="text" class="" placeholder="" name="Image" value="'.$data['Image'].'"/></td>
								<td><input type="file" name="uploadedPic" name="picLoad"></input></td>
