...
?>
      ...
      <div class="jumbotron">
        <h1>Favourites</h1>
        <p class="lead">View your favourite flowers</p>
      </div>
      ...
      <div class="row">
		<?php
			$query = "select * from sf_favourites where user_id = '$userIdInTable'";
			...
			while ($data = mysql_fetch_array($result)){
				...
				echo '
					...
					<div class="col-xs-6 col-sm-3 placeholder">
						...
						<a href="../sources/php/add_watch_fav.php?id=delfav&main_category='.$main_category.'&sub_category='.$sub_category.'&flower_color='.$flower_color.'&flower_height='.$flower_height.'&flower_extra='.$flower_extra.'&flower_name='.$flower_name.'&flower_Price='.$flower_Price.'"><button class="btn"><span class="fa fa-times-circle"></span>Remove</button></a>
