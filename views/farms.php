...
$result = mysql_query("select * from sf_flowers_farms");


echo '<h1 class="page-header" style="color:#944D94;">Palms</h1>';
...
while ($data = mysql_fetch_array($result)) {
  ...
  <div class="placeholders" style="margin-top:40px;">
        ...
        <a href="descriptive.php?main=Farms&sub='.$image_subCategory.'&color='.$image_color.'&extra='.$image_extra.'" >
              <img src="../img/Flowers/Farms/'.$image_name.'"  class="img-responsive" alt="Farm plant Image">
        </a>      
