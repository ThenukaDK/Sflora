<?php
	...
	mysql_select_db('sflora') or die("Not connected to the db") or die("not concted");

	if(isset($_POST['userMsg'])){
		$userId=$_SESSION['userIdInTable'];
		$userName = $_GET['userNameInTable'];
		...
		$sql ='INSERT INTO sf_messages VALUES('.'"'.$messageId.'","'.$userId.'","'.$userName.'","'.$subject.'","'.$message.'","","","'.$dateTime.'")';
		$reslt=mysql_query($sql);
		header("Location:../../views/help-messageUs.php");
	}
